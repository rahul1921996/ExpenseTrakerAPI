drop database expensetrakerdb;
drop user expensetraker;
create user expensetraker with password 'password';
create database expensetrakerdb with template=template0 owner=expensetraker;
\connect expensetrakerdb;
alter default privileges grant all on tables to expensetraker;
alter default privileges grant all on sequences to expensetraker;
